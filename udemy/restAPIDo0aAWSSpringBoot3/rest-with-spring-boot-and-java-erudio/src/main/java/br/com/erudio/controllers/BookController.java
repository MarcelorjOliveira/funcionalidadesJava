...
public class BookController {
	...
	@PostMapping(consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML},
			produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Adds a new Book by passing a JSON, XML or YAML", description = "Adds a new Book by passing a JSON, XML or YAML", tags = {"Book"},
	responses = {
			@ApiResponse(description = "Success", responseCode = "200",
					content = {
							@Content(schema = @Schema( implementation = BookVO.class))
	...
	@Operation(summary = "Deletes a Book by passing in a JSON, XML or YAML", description = "Deletes a Book by passing in a JSON, XML or YAML", tags = {"Book"},
	responses = {
			@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
			@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
			@ApiResponse(description = "Unahthotrized", responseCode = "401", content = @Content),
